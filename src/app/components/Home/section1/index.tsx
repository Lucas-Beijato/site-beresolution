...
export default function Section1() {
  return (
    <div className="w-full h-fit overflow-hidden">
      <video className="videoHome xl:object-contain object-cover" autoPlay loop muted>
      ...
      <Section>
        ...
        <Link className="bg-BeGreenColor shadow-lg w-fit px-2 py-2 rounded-lg xl:px-4 mb-20 xl:mb-40 text-xl xl:text-2xl font-semibold text-white hoverGlowUp" href="#atividades">Atividades</Link>
