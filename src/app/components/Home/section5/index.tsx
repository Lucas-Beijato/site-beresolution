  ...
  return (
    <Section>
      ...
      <div className="flex flex-col">
        ...
        <div onClick={() => { setShowHideSuporte(!showHideSuporte) }} className="h-fit cursor-pointer rounded-lg border-2 mt-5 p-3 xl:p-5 border-BeGreenColor hoverGlowUp2">
          <div className="flex flex-row justify-between items-center py-2">
        ...
        <div onClick={() => { setShowHideDesenvolvimento(!showHideDesenvolvimento) }} className="h-fit cursor-pointer rounded-lg border-2 mt-5 p-3 xl:p-5 border-BeGreenColor hoverGlowUp2">
          <div className="flex flex-row justify-between items-center py-2">
