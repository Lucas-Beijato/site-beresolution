...
export default function Section4() {
  return (
    ...
    >
      ...
      <Link className="bg-BeGreenColor shadow-lg z-10 w-fit py-4 rounded-lg px-4 text-xl xl:text-2xl font-semibold text-white transition transform duration-150 hover:scale-105" href="#contato">Entre em contato</Link>
    </CustomSection>
  )
}
