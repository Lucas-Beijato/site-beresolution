...
export default function Section4() {
  return (
    <Section>
      ...
      <div className="flex flex-row flex-wrap justify-between mt-14 mb-10 xl:w-[900px]">
        <div className="flex flex-col justify-center items-center w-52 mt-4">
      ...
      <Link className="bg-BeGreenColor shadow-lg w-fit py-4 rounded-lg px-4 text-2xl font-semibold text-white transition transform duration-150 hover:scale-105" href="#contato">Entre em contato</Link>
