...
export default function Section4() {
  return (
    <Section>
      ...
      <h2 id="sobreNos" className="text-white w-full text-4xl xl:text-5xl text-start font-bold mb-3 scroll-mt-56">Conheça a <br/><span className="text-BeGreenColor">Be Resolution</span></h2>
